...
public @interface Sbb {
    ...
    String sbbLocalInterfaceName() default "";

    String sbbLocalInterfaceDescription() default "";

    String sbbActivityContextInterfaceName() default "";

    String sbbActivityContextInterfaceDescription() default "";

    String sbbUsageParameterInterfaceName() default "";
